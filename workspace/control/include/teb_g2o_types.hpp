...
public:
  ...
  void linearizeOplus() override {
    // Initialize Jacobian matrices for all 3 vertices
    _jacobianOplus[0].resize(2, 3); // p1: 3 DOF
    _jacobianOplus[1].resize(2, 3); // p2: 3 DOF
    _jacobianOplus[2].resize(2, 1); // dt: 1 DOF
    
    // Set to zero (numerical differentiation will handle the rest)
...
// Edge: holonomic velocity (penalize lateral slip)
...
public:
  ...
  void linearizeOplus() override {
    // Initialize Jacobian matrices for all 3 vertices
    _jacobianOplus[0].resize(1, 3); // p1: 3 DOF
    _jacobianOplus[1].resize(1, 3); // p2: 3 DOF
    _jacobianOplus[2].resize(1, 1); // dt: 1 DOF
...
public:
  ...
  void linearizeOplus() override {
    // Initialize Jacobian matrices for all 5 vertices
    _jacobianOplus[0].resize(1, 3); // p0: 3 DOF
    _jacobianOplus[1].resize(1, 3); // p1: 3 DOF  
    _jacobianOplus[2].resize(1, 3); // p2: 3 DOF
    _jacobianOplus[3].resize(1, 1); // dt_prev: 1 DOF
    _jacobianOplus[4].resize(1, 1); // dt_next: 1 DOF
